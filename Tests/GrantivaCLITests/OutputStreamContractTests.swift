...
final class OutputStreamContractTests: XCTestCase {
    ...
    func testConsoleSubcommandsParseAndExposeGlobalFlags() throws {
        for arguments in [
            ...
            ["console", "devices", "get"],
            ["console", "devices", "list"],
            ["console", "apps", "list"],
            ["console", "apps", "get"],
            ["console", "apps", "register"],
            ["console", "apps", "update"],
            ["console", "apps", "delete"],
            ["console", "apps", "activate"],
            ["console", "apps", "deactivate"],
            ["console", "apps", "set-primary"],
            ["console", "claims", "list"],
            ["console", "claims", "get"],
            ["console", "claims", "create"],
            ["console", "claims", "update"],
            ["console", "claims", "delete"],
            ["console", "claims", "reorder"],
            ["console", "claims", "test"],
            ["console", "claims", "preview"],
            ["console", "vrt", "runs", "list"],
            ["console", "vrt", "runs", "get"],
            ["console", "vrt", "approve"],
            ["console", "vrt", "reject"],
            ["console", "vrt", "screen", "accept"],
            ["console", "vrt", "screen", "flag"],
            ["console", "vrt", "screen", "reset"],
            ["console", "releases", "list"],
            ["console", "releases", "get"],
            ["console", "releases", "create"],
            ["console", "releases", "update"],
            ["console", "releases", "publish"],
            ["console", "releases", "unpublish"],
            ["console", "releases", "delete"],
            ["console", "feedback", "list"],
            ["console", "feedback", "get"],
            ["console", "feedback", "set-status"],
            ["console", "feedback", "comment"],
            ["console", "support", "list"],
            ["console", "support", "get"],
            ["console", "support", "reply"],
            ["console", "support", "set-status"],
            ["console", "support", "set-priority"],
            ["console", "webhooks", "list"],
            ["console", "webhooks", "get"],
            ["console", "webhooks", "create"],
            ["console", "webhooks", "enable"],
            ["console", "webhooks", "disable"],
            ["console", "webhooks", "update"],
            ["console", "webhooks", "delete"],
            ...
            ["console", "alerts", "rules", "delete"],
            ["console", "alerts", "rules", "deliveries"],
            ["console", "alerts", "failure-rate", "get"],
            ["console", "alerts", "failure-rate", "set"],
            ["console", "alerts", "failure-rate", "history"],
            ["console", "alerts", "notifications", "get"],
            ["console", "alerts", "notifications", "set"],
            ["console", "keys", "list"],
            ["console", "keys", "get"],
            ["console", "keys", "create"],
            ["console", "keys", "rotate"],
            ...
            ["console", "team", "invite"],
            ["console", "team", "revoke-invite"],
            ["console", "team", "remove"],
            ["console", "audit", "list"],
            ["console", "org", "settings", "get"],
            ["console", "org", "settings", "set-name"],
            ["console", "org", "usage"],
            ["console", "org", "billing", "show"],
            ["console", "open"],
        ] {
